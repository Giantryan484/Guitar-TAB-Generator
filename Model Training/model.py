...
import os
from tensorflow.keras.layers import Conv2D, BatchNormalization, Dropout, Conv2DTranspose, MaxPooling2D, Input, concatenate # type: ignore (why does pylance get angry at this line always)
